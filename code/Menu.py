...
from code.Const import WIN_WIDTH, C_ORANGE, MENU_OPTION, C_WHITE, C_RED
    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(text_size=20, text=MENU_OPTION[i], text_color=C_RED, text_center_pos=((WIN_WIDTH / 2), 200 + 25 * i))
